...
a.bg-danger:focus, a.bg-danger:hover {
    background-color: #c33716 !important;
}
...
.align-items-center, .navbar .navbar-menu-wrapper .navbar-nav .nav-item.dropdown .navbar-dropdown .dropdown-item, .loader-demo-box {
...
.ml-0, .rtl .navbar .navbar-menu-wrapper .search-field, .rtl .preview-list .preview-item .preview-thumbnail .preview-icon i,
.mx-0 {
